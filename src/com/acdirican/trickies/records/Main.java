...
/**
 * Record: To overcome boilerplate code.  It allows us to have immutable objects writing very little code.
 * 
 * A record
 *  - can have multiple constructors
 *  - can have static attributes and methods
 *  - implements interfaces
 *  - cannot extends a class because it already extends java.lang.Record
