...
/**
 * Runtime class is for interaction runtime Java environment. You can execute a
 * process, invoke GC and get statistics about memory.
 * 
 * It is in java.lang and it has only one instance java.lang.RunTime. You uses
 * getInstance() method to access the only instance.
 * 
 * 
